...
public class EstimateDao {
    ...
    public int insertCustomer(Customer customer) {
        String sql = "INSERT INTO CUSTOMER(OLD_PREFECTURE_ID, NEW_PREFECTURE_ID, CUSTOMER_NAME, TEL, EMAIL, OLD_POSTALCODE, OLD_ADDRESS,  NEW_POSTALCODE, NEW_ADDRESS)"
                + " VALUES(:oldPrefectureId, :newPrefectureId, :customerName, :tel, :email, :oldPostalcode, :oldAddress, :newPostalcode, :newAddress)";
